#pragma checksum "C:\Users\SCG EXPRESS\Git\MvcAndAngularForSCGESafety\VK1.SCGE.Safety.Mvc\Views\DashboardYearly\IndexDashBoardYear.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d84e276906dd2d63807aa5cde0b7883a4225d614"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_DashboardYearly_IndexDashBoardYear), @"mvc.1.0.view", @"/Views/DashboardYearly/IndexDashBoardYear.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d84e276906dd2d63807aa5cde0b7883a4225d614", @"/Views/DashboardYearly/IndexDashBoardYear.cshtml")]
    ...
    public class Views_DashboardYearly_IndexDashBoardYear : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "C:\Users\SCG EXPRESS\Git\MvcAndAngularForSCGESafety\VK1.SCGE.Safety.Mvc\Views\DashboardYearly\IndexDashBoardYear.cshtml"
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "d84e276906dd2d63807aa5cde0b7883a4225d6147081", async() => {
            }
            );
...
<div class=""d-flex justify-content-between mt-2"">
    <div class=""card"" style=""width:255px;height:282.67px"">
        <div class=""card-body pb-0"">
            <div id=""dataCasetype"">
                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "d84e276906dd2d63807aa5cde0b7883a4225d6148495", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_PartialTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.PartialTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_TagHelpers_PartialTagHelper);
    ...
    <div class=""card"" style=""width:255px;height:282.67px"">
        <div class=""card-body pb-0"">
            <div id=""dataRank"">
                ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "d84e276906dd2d63807aa5cde0b7883a4225d61410155", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_PartialTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.PartialTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_TagHelpers_PartialTagHelper);
...
");
            DefineSection("Styles", async() => {
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "d84e276906dd2d63807aa5cde0b7883a4225d61412060", async() => {
                }
                );
...
#nullable restore
#line 86 "C:\Users\SCG EXPRESS\Git\MvcAndAngularForSCGESafety\VK1.SCGE.Safety.Mvc\Views\DashboardYearly\IndexDashBoardYear.cshtml"
...
#nullable disable
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#labelChart1,#labelChart2,#labelChart3').hide();
        })
        ...
        $('#ddlRegion').on('change', () => {
            ...
            const url = `/");
                WriteLiteral(@"AccidentReports/GetBranch/${region}`;
            $.get(url).then(res => {
                $('#ddlBranch').empty();
        ...
        $('#btnSearch').click(() => {
            ...
            fnMontlyTransportC");
                WriteLiteral(@"arrier(year, region, branch);
        ...
        function fnSummaryCaseType(year, region, branch) {
            ...
            const url = `/Dashboards/SummaryByCaseType?year=${year}&regionId=${region}&branchCode=${branch}`;
            $.get(url).then(res => {
        ...
        function fnPiechartVehicle(year, region, branch) {
            const url = `/Dashboards/SummaryByVehicleType?year=${year}&regionId=${region}&branchCode=${branch}`;
            $.get(url).then(res => {
                vehiclePiechartData = res.chartdata;
                titleYear = res.year;
     ");
                WriteLiteral(@"           subtitle = res.region !== '' ? '-' + res.region : res.branch;
            }).done(function () {
                $('#labelChart1').show();
                ...
                function drawChart() {
                    ...
                    var options = {
                      ...
                      ");
                WriteLiteral(@"  pieSliceText: 'value-and-percentage',
        ...
        function fnSummaryByRank(year, region, branch) {
            const url = `/Dashboards/SummaryByRank?year=${year}&regionId=${region}&branchCode=${branch}`;
            $.get(url).then(res => {
                $('#dataRank').html(res);
            })
        }
        ...
        function fnSummaryByAccidentMode(year, region, branch) {
            const url = `/Dashboards/SummaryByAccidentMode?year=${year}&regionId=${region}&branchCode=${branch}`;
            $.get(url).then(res => {
                accidentModePiechartData = res.chartdata;
                titleYear = res.year;
                subtitle = res.region !== '' ? '-' + res.region : res");
                WriteLiteral(@".branch;
            }).done(function () {
                $('#labelChart2').show();
                google.setOnLoadCallback(drawChart);
                function drawChart() {
                    ...
                    var options = {
                        ...
                        //pieS");
                WriteLiteral(@"liceText: 'percentage',
                        fontSize: 14,
                    };
        ...
        function fnSummaryByIncident(year, region, branch) {
            const url = `/Dashboards/SummaryByIncident?year=${year}&regionId=${region}&branchCode=${branch}`;
            $.get(url).then(res => {
                incidentPiechartData = res.chartdata;
                titleYear = res.year;
                subtitle = res.region !== '' ? '-' + res.region : res.branch;
                ...
                function drawChart() {
                    ...
                    var view = new google.visualization.DataView(data);
        ");
                WriteLiteral(@"            subtitle = subtitle === '-null' ? '' : subtitle;
                    var options = {
        ...
        function fnMontlyTransportScg(year, region, branch) {
            const url = `/Dashboards/MonthlyTransportScg?ye");
                WriteLiteral(@"ar=${year}&regionId=${region}&branchCode=${branch}`;
                    ...
                    var options = {
                        ...
                        annotations: {
                            textStyle: {
                                ...
                                color: '#871b47',
                                // The c");
                WriteLiteral(@"olor of the text outline.
                                //auraColor: '#d799ae',
        ...
        function fnMontlyTransportCarrier(year, region, branch) {
            const url = `/Dashboards/MonthlyTransportCarrier?year=${year}&regionId=${region}&branchCode=${branch}`;
        ...
        function fnSummaryByTransport(year, region, branch) {
            ...
            const url = `/Dashboards/SummaryByTransport?year=${year}&regionId=${region}&branchCode=${branch}`;
            ...
            $.get(url).then(res => {
                ...
                function drawTable() {
                    var data = new google.visualization.DataTa");
                WriteLiteral(@"ble();
                    ...
                    // ");
                WriteLiteral(@"   'selectedTableRow': 'orange-background large-font',
                    //    'hoverTableRow': '',
        ...
        function fnMontlyOtherScg(year, region, branch) {
            const url = `/Dashboards/MonthlyOtherScg?year=${year}&regionId=${region}&branchCode=${branch}`;
            ...
            $.get(url).then(res => {
                ...
                function drawChart() {
                    ...
                    subtitle = subti");
                WriteLiteral(@"tle === '-null' ? '' : subtitle;
                    var options = {
                        ...
                        annotations: {
                            textStyle: {
                                ...
                                color: '#871b47',
      ");
                WriteLiteral(@"                          // The color of the text outline.
                                //auraColor: '#d799ae',
                                // The transparency of the text.
                                //opacity: 0.8
                            }
        ...
        function fnMontlyOtherCarrier(year, region, branch) {
            const url = `/Dashboards/MonthlyOtherCarrier?year=${year}&regionId=${region}&branchCode=${branch}`;

            $.get(url).then(res => {
                monthlyOtherCarrier = res.chartData;
            ");
                WriteLiteral(@"    titleYear = res.year;
                subtitle = res.region !== '' ? '-' + res.region : res.branch;
            }).done(function () {
                google.setOnLoadCallback(drawChart);
                function drawChart() {
                    ...
                    var options = {
                        ...
                        annotations: {
                            textStyle: {
                                ...
                                //auraColor: '#d799ae',
                                // Th");
                WriteLiteral(@"e transparency of the text.
                                //opacity: 0.8
                            }
                        },
                        chartArea: {
        ...
        function fnSummaryByOther(year, region, branch) {
            ...
            const url = `/Dashboards/SummaryByOther?year=${year}&regionId=${region}&branchCode=${branch}`;
...
");
                ...
                function drawTable() {
                    ...
                    //var cssClassNames = {
                   ");
                WriteLiteral(@" //    'headerRow': 'italic-darkblue-font large-font bold-font',
                    //    'tableRow': '',
                    //    'oddTableRow': 'beige-background',
